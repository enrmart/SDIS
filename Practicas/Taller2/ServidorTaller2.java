...
public class ServidorTaller2 {
    public static void main(String args[]) {
    int PUERTO = 2000;
    int NThreads = 5;

        distribuidos.mapqueue.MultiMap<String, String> mapa = new distribuidos.mapqueue.MultiMap<>();
            ...
            Thread mainServer = new Thread(() -> {
                try {
                    ...
                    while (true) {
                        ...
                        try  {
                           SirvienteTaller2 serv =new SirvienteTaller2(socket, mapa);
                            exec.execute(serv);
