...
public class MensajeProtocolo implements java.io.Serializable {
 ...
 //ES NECESARIO QUE EL CORRECTOR TENGA LA CLASE MALMENSAJEPROTOCOLOEXCEPTION, YA QUE NO YO ENVIO ESE ARCHIV //ES NECESARIO QUE EL CORRECTOR TENGA LA CLASE MALMENSAJEPROTOCOLOEXCEPTION, YA QUE NO YO ENVIO ESE ARCHIVO
  ...
  public MensajeProtocolo(Primitiva p, String mensaje)
    ...
    if (p == Primitiva.HELLO || p == Primitiva.PULL_OK) {
      ...
      this.idCola  = null;
    } else if (p == Primitiva.PULL_WAIT || p == Primitiva.PULL_NOWAIT || p == Primitiva.PULLFAIK) {
      this.idCola  = mensaje;  //similar solo que utilizara un metodo distinto en MultiMap
      this.mensaje = null;
    } else
      throw new MalMensajeProtocoloException();
    this.primitiva = p;
...
/*Constructor nueva primitiva */
 /* public MensajeProtocolo(Primitiva p, String idCola, String mensaje)
  	throws MalMensajeProtocoloException {
	if(p == Primitiva.PULLFAIK){
		this.primitiva= p;
		this.mensaje = mensaje;
		this.idCola = null;
		}else
...
*/
  ...
  public String toString() { /* prettyPrinter de la clase */
   ...
   /*   case PULLFAIK:
      	return this.primitiva+"(nueva creada): "+this.idCola+": mensaje: "+this.mensaje;*/
      default :
